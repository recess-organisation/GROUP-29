export default function Modal({ title, message, onConfirm, onCancel, confirmText = 'Confirm', cancelText = 'Cancel', danger = false, inputLabel, inputValue, inputType = 'text', onInputChange }) {
  return (
    <div style={{
